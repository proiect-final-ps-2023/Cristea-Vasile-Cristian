...
export const GET_WALKING_ACHIEVEMENTS_URL = `${BASE_URL}/user/getWalkingAchievements/`
export const GET_RUNNING_ACHIEVEMENTS_URL = `${BASE_URL}/user/getRunningAchievements/`
export const GET_CYCLING_ACHIEVEMENTS_URL = `${BASE_URL}/user/getCyclingAchievements/`
