...
public class UserController {
    ...
    @GetMapping("/getWalkingAchievements/{userId}")
    public ResponseEntity<List<UserAchievementDTO>> getWalkingAchievements(@PathVariable long userId) {
        return ResponseEntity.ok(userService.getWalkingAchievements(userId));
    }

    @GetMapping("/getRunningAchievements/{userId}")
    public ResponseEntity<List<UserAchievementDTO>> getRunningAchievements(@PathVariable long userId) {
        return ResponseEntity.ok(userService.getRunningOrCyclingAchievements(userId, ActivityTypeEnum.RUNNING));
    }

    @GetMapping("/getCyclingAchievements/{userId}")
    public ResponseEntity<List<UserAchievementDTO>> getCyclingAchievements(@PathVariable long userId) {
        return ResponseEntity.ok(userService.getRunningOrCyclingAchievements(userId, ActivityTypeEnum.CYCLING));
    }
}
